Option Explicit
Sub AutoOpen()
    ActiveWindow.ActivePane.View.Zoom.Percentage = 12
    'MsgBox "AutoOpen done"
End Sub
Sub TableWidthPercent()
Dim tbl As Table
...
Sub Markup_Open()
' Sets the markup in the document in the active window

' Automatically track changes and set to no markup
...
Sub ResetParaSpacing()
'
' This macro resets the paragraph spacing and multiple spaces
'
'
